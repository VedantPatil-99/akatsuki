        ...
        <DropdownMenuGroup>
          ...
          >
            ...
            <Switch
              ...
              onCheckedChange={setGoogleSwitch}
            />
          </DropdownMenuItem>
          <DropdownMenuItem
            className="justify-between"
          ...
          >
            ...
            <Switch
              id="airplane-mode"
              checked={twitterSwitch}
              onCheckedChange={setTwitterSwitch}
            />
          </DropdownMenuItem>
          <DropdownMenuItem
            className="justify-between"
          ...
          >
            ...
            <Switch
              id="airplane-mode"
              checked={linkedinSwitch}
              onCheckedChange={setLinkedinSwitch}
            />
          </DropdownMenuItem>
          <DropdownMenuItem
            className="justify-between"
          ...
          >
            ...
            <Switch
              id="airplane-mode"
              checked={dribbbleSwitch}
              onCheckedChange={setDribbbleSwitch}
            />
          </DropdownMenuItem>
          <DropdownMenuItem
            className="justify-between"
          ...
          >
            ...
            <Switch
              id="airplane-mode"
              checked={behanceSwitch}
              onCheckedChange={setBehanceSwitch}
            />
          </DropdownMenuItem>
        </DropdownMenuGroup>
      </DropdownMenuContent>
